...
<div style="border: 2px solid red; margin: 1em; padding: 0 1em; font-size: larger;">
<h2>Customized for Arise Energy</h2>
<p>Added code to export the json report in addition to the primary report.</p>
</div>
